...
// ******** Changes to support 8MHz processors as well as 16MHz processors. ***********
// The original design was for 16MHz CPUs only.
// The following returns a value of either 1 or 2 for a 16MHz CPU or an 8MHz CPU.
#define TimingFactor (16000000L/F_CPU)
// The following value "(256/TimingFactor)" has been substituted for the four instances of "128" 
// ***************************
...
#define FRAME_SYNC_DELAY   ((FRAME_SYNC_PERIOD/TimingFactor - ( NBR_CHANNELS * DEFAULT_PULSE_WIDTH/TimingFactor))/128) // number of iterations of the ISR to get the desired frame rate 
...
static void writeChan(uint8_t chan, int pulsewidth)
{
   ...
   { 
	...
	pulsewidth = pulsewidth / TimingFactor;
